...
if __name__ == '__main__':
    ...
    # cosine_angles_data_normalized = scaler.fit_transform(cosine_angles_data)
    # mean_positions_data_normalized = scaler.fit_transform(mean_positions_data)
    # std_positions_data_normalized = scaler.fit_transform(std_positions_data)
